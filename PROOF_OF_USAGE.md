...
<!-- The example row's hash is the real digest of its own four fields against
     https://github.com/ebellumat/oakbarrel, so it does not match this repository's URL - it is an
...
npx proof-of-usage hash \
  ...
  --repo "https://github.com/ebellumat/oakbarrel"
```

```bash
printf '%s' "ExampleModel v2:AI Corp:2026-08-12T14:30:00Z:https://github.com/ebellumat/oakbarrel" | shasum -a 256
```

```python
import hashlib
hashlib.sha256("ExampleModel v2:AI Corp:2026-08-12T14:30:00Z:https://github.com/ebellumat/oakbarrel".encode()).hexdigest()
```
...
2. **There.** In the credits your product already publishes — credits screen, about page,
   ...
   ```
   Includes material from ebellumat/oakbarrel — https://github.com/ebellumat/oakbarrel
